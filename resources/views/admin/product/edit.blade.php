        ...
        <form action="{{ route('edit-product',$product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" id="small_description" name="small_description"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" value="{{ $product->selling_price }}" id="selling_price"
                        name="selling_price">
                </div>
                <div class="col-md-12 mb-3">
                    <label for="image" class="form-label">Image</label>
                    <input type="file" class="form-control" id="image" name="image">
                    <model-viewer src="{{asset('upload/image/product/'.$product->image)}}" width="50" height="50"
                        value="{{$product->image}}" name="image"></model-viewer>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="checkbox" class="btn-check" {{ $product->trending == '1' ? 'checked': ''}}
                    id="trending"
                    name="trending">
                </div>
                <div class="col-md-12 mb-3">
